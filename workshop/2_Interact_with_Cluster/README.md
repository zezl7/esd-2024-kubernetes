...
Congrats! You have passed the talking stage with your local K8s cluster. Now, let the [configuration](https://github.com/zezl7/esd-2024-kubernetes/tree/main/workshop/3_Create_Configurations) begin. 👽
